    ...
    private void doGet(HttpRequest request, HttpResponse response) throws IOException {
        ...
        if (request.getUrl().startsWith("/index.html")) {
            ...
            if (sessionId == null || user == null) {
                ...
                //HttpServer3.class获取一个类的"类对象"
                //.getClassLoader()获取当前类的"类加载器"
                //.getResourceAsStream("index.html");根据文件名。
                // 在Resouces目录中找到对应的文件并打开，返回这个文件的InputStream
...
//            System.out.println("password: " + password);
            ...
            if ("xxn".equals(userName) && "123".equals(password)) {
                // 登陆成功
                response.setStatus(200);
                response.setMessage("OK");
                response.setHeader("Content-Type", "text/html; charset=utf-8");
    ...
    public static void main(String[] args) throws IOException {
        HttpServer3 serverV3 = new HttpServer3(9090);
        serverV3.start();
    }
}